...
<h1 class="text-danger text-center bg-dark">Add New Course Here</h1>
<div class="container">
...
<h1 class="text-center bg-info text-white">Course info</h1>
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" class="form-control" name="course_name"placeholder="Enter course_name" value="{{old('course_name')}}">
    @error('course_name')
<p class="text-danger">{{$message}}</p>
@enderror
